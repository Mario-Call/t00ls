...
- 名称：`马里奥'Blog`
- 描述：`Web安全、CTF安全自留地`
- 地址：`https://www.t00ls.cc`
- 头像：`https://www.t00ls.cc/logo.png`
- 站点图片：`https://www.t00ls.cc/logo.png`
- 订阅：`https://www.t00ls.cc/rss.xml`

```yml
name: 马里奥'Blog
desc: Web安全、CTF安全自留地
url: https://www.t00ls.cc
avatar: https://www.t00ls.cc/logo.png
screenshot: https://www.t00ls.cc/logo.png
rss: https://www.t00ls.cc/rss.xml
```

### 申请友链

- 我已添加 [马里奥'Blog](https://www.t00ls.cc/) 的友情链接。

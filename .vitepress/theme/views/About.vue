  ...
  <div class="about">
    ...
    <div class="about-content" style="grid-template-columns: 3fr 2fr">
      ...
      <div class="about-item hello">
        ...
        <span class="text2 title2">我是 马里奥</span>
        <span class="text3">是一名 网络安全爱好者、运维工程师、CTF选手</span>
      </div>
      <!-- 追求 -->
      <div class="about-item pursuit">
        <span class="tip">追求</span>
        <span class="title2">源于兴趣</span>
        <span class="title2">从兴趣到生活</span>
        <span class="title2">从兴趣到职业</span>
      </div>
    </div>
    <div class="about-content" style="grid-template-columns: 2fr 3fr">
      ...
      <div class="about-item career">
        ...
        <div class="list">
          <span class="list-item" style="--color: #357ef5">Web·渗透测试</span>
          <span class="list-item" style="--color: #eb372a">Linux·运维工程师</span>
        </div>
        <img
          class="career-img"
    ...
    <div class="about-content" style="grid-template-columns: 3fr 2fr">
      ...
      <div class="about-item character" style="--color: #4298b4">
        ...
        <span class="title2">Web狗、CTF初级选手</span>
      ...
      <div class="about-item child">
        ...
        <div class="about-item info">
          ...
          <div class="info-item">
            ...
            <span class="info-num" style="--color: #dfac46">信息安全工程师</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="about-content" style="display: flex">
      <div class="about-item">
        <span class="tip">个人介绍</span>
        <span class="title2">ID：Mario</span>
        <p class="text">
          一名网络安全从业者。<strong>积累知识</strong>，<strong>一切源于兴趣</strong>。从兴趣到生活，从兴趣到职业。<strong>一只只会Web的菜鸡，希望自己可以努力向上！</strong>。如果能够帮助到更多的人，帮助更多人解决问题，那一定是非常棒的事情。
        </p>
      </div>
    </div>
  </div>

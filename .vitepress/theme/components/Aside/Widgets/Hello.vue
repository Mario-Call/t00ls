...
<template>
  <div class="hello s-card" @mouseleave="resetHello">
    ...
    <div class="content">
      <div data-v-30dbac14="" class="site-logo">
        <img
    class="logo-img"
  ...
  />
    ...
    <div class="info">
      ...
      <div class="link">
        <a href="https://github.com/Mario-Call" target="_blank" class="social-link">
          <i class="iconfont icon-github"></i>
        </a>
        <a href="mailto:one@2813955543@qq.com" target="_blank" class="social-link">
...
.logo-img {
  width: 100%;
  height: 100%;
  object-fit: contain;            /* 让 logo 完整可见 */

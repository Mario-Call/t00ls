...
export const themeConfig = {
  ...
  siteMeta: {
    ...
    author: {
      ...
      link: "https://www.t00ls.cc",
    },
  },
  // 备案信息
  icp: "京ICP备2025123819号-2",
  // 建站日期
  since: "2025-08-21",
  // 每页文章数据
  postSize: 8,
  ...
  nav: [
    ...
    },
    {
      ...
      items: [
        ...
        { text: "安全导航", link: "/pages/tools", icon: "tools" },
      ],
    },
    {
      text: "友链",
  ...
  footer: {
    ...
    social: [
      ...
      {
        icon: "qq",
        link: "https://res.abeim.cn/api/qq/?qq=2813955543",
      },
      {
        icon: "twitter-x",
        link: "https://twitter.com/AKcooling",
      },
    ],
    // sitemap
    sitemap: [
      ...
      },
      {
        text: "服务",
        items: [
          { text: "站点状态", link: "https://www.t00ls.cc", newTab: true },
          { text: "安全导航", link: "/pages/tools", newTab: true },
          { text: "站点订阅", link: "https://t00ls.cc/rss.xml", newTab: true },
          {
            text: "反馈投诉",
            link: "mailto:2813955543@qq.com",
            newTab: true,
  ...
  aside: {
    ...
    hello: {
      enable: true,
      text: "这里有关于<strong>网络安全</strong>相关的问题和看法，也会有一些<strong>CTF奇技淫巧</strong>的分享，其中大部分内容会侧重于<strong>运维、安全</strong>。希望你可以在这里找到对你有用的知识和教程。",
    },
    // 目录
    toc: {
      enable: true,
